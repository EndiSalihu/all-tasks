export const multipleAccordion_data = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: 'Yes, Parkname Parking is completely free to use.',
      },
      {
        title: 'What you do?',
        content: 'We provide a platform for domain name parking that allows you to monetize your unused domains.',
      },
      {
        title: 'When was Parkname first founded?',
        content: 'Parkname was founded in 2020.',
      },
    ],
  }
];